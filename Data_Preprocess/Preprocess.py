...
parser.add_argument('--img_path', type=str,default="CelebA-HQ128")
parser.add_argument('--label_path', type=str,default="CelebA-HQ-attribute-anno.txt")
parser.add_argument("--target_path",type=str,default="Samples128")
...
#使用Male和Young作为无关标签，用于优化鉴别器，并计算FID (Disentanglement)
